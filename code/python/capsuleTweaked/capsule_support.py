...
config.ECHO_NEST_API_KEY="S4ODHZMNSUP375NAE" 

import numpy as np
from copy import deepcopy
from echonest.action import Crossfade, Playback, Crossmatch, Fadein, Fadeout, humanize_time, Blend
...
def make_crossmatch(track1, track2, rate1, rate2, loc2, rows):
    ...
    #return Blend((track1, track2), (to_tuples(markers1, start1, rows), to_tuples(markers2, start2, rows)))
